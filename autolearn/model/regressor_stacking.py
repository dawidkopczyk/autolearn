...
class RegressorStacking(Regressor):
    ...
    def get_params(self, deep=True):
        ...
        params = {}
        params.update(super(RegressorStacking, self).get_params())
    ...
    def transform(self, X=None):
        ...
        for c, est in enumerate(self.base_estimators):
            ...
            if type(est) == tuple:
                ...
                if self.base_save:
                    if self.base_save_files is not None:
                        np.save(self.base_save_files[c][1], y_pred)
                    else:
                        np.save('est' + str(c) + '_test', y_pred)
    ...
    def fit(self, X=None, y=None, **kwargs):
        ...
        return super(RegressorStacking, self).fit(X, y, **kwargs)
    ...
    def predict(self, X=None):
        ...
        return super(RegressorStacking, self).predict(X)
    
    def cross_val_predict(self, X=None, y=None, cv=None, scoring=None, **kwargs):  
        if X is not None and y is not None:
            X = self.fit_transform(X, y)
        else:
            if y is None:
        ...
        return super(RegressorStacking, self).cross_val_predict(X, y, cv=cv, scoring=scoring, **kwargs)
    ...
    def cross_validate(self, X=None, y=None, cv=None, scoring=None, **kwargs):
        ...
        return super(RegressorStacking, self).cross_validate(X, y, cv=cv, scoring=scoring, **kwargs)
