...
class StackingClassifier(Classifier):
    ...
    def __init__(self, modelname, base_estimators, num_bagged_est=None, random_state=None,
        ...
        base_estimators : list of Classifier objects/tuples
        ...
        **kwargs : default = None
        ...
        super(StackingClassifier, self).__init__(modelname, 
        ...
        for i, est in enumerate(self.base_estimators):
            ...
            elif isinstance(est, Classifier):
                self.base_estimators[i] = make_copy(est)
            else:
               raise ValueError("Elements of base_estimators must be either Classifier or tuple.")
        ...
        self.__basefittransformOK = False
        self.__basetransformOK = False
        
    def get_params(self, deep=True):

        params = {}
        params.update(super(StackingClassifier, self).get_params())
    ...
    def set_params(self, **params):
        ...
        super(StackingClassifier, self).set_params(**params)

    def base_fit_transform(self, X=None, y=None, **kwargs):
        ...
        **kwargs : default = None
        ...
        for c, est in enumerate(self.base_estimators):
            ...
            if type(est) == tuple:
                ...
                raise ValueError("X and y must be specified to fit_transform base Classifiers.")
        ...
        self.__y = y
        self.__basefittransformOK = True    
        
        return self

    def base_transform(self, X=None):
        ...
        if not self.__basefittransformOK:
            raise ValueError("Call base_fit_transform before !")
        ...
        self.__basetransformOK = True
        
        return self
    
    def fit(self, X=None, y=None, **kwargs):
        if X is not None and y is not None:
            self.base_fit_transform(X, y)
        if y is None:
            y = self.get_y
        ...
        return super(StackingClassifier, self).fit(X, y, **kwargs)
 
    def predict(self, X=None):
        if X is not None:
            self.base_transform(X)
    ...
    def predict_log_proba(self, X=None):
        ...
        return super(StackingClassifier, self).predict_log_proba(X)
    ...
    def predict_proba(self, X=None):
        ...
        return super(StackingClassifier, self).predict_proba(X)
    ...
    def cross_val_predict_proba(self, X=None, y=None, cv=None, scoring=None, **kwargs):  
        ...
        return super(StackingClassifier, self).cross_val_predict_proba(X, y, cv=cv, scoring=scoring, **kwargs)
    ...
    def cross_validate(self, X=None, y=None, cv=None, scoring=None, **kwargs):
        ...
        return super(StackingClassifier, self).cross_validate(X, y, cv=cv, scoring=scoring, **kwargs)
    
    @property
    def get_meta_train(self):
        """Get training meta-features."""
        if not self.__basefittransformOK:
            raise ValueError('No training meta-features found. Need to call base_fit_transform beforehand.')
    ...
    def get_y(self):
        """Get training meta-features."""
        if not self.__basefittransformOK:
            raise ValueError('No y found. Need to call base_fit_transform beforehand.')
        return self.__y
    
    @property
    def get_meta_test(self):
        """Get training meta-features."""
        if not self.__basetransformOK:
            raise ValueError('No test meta-features found. Need to call base_transform beforehand.')
